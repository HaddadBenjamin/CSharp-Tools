...
namespace BenTools.Helpers
{
    ...
    public static class ValidationHelper
    {
        ...
        private static ArgumentOutOfRangeException RangeException(object value, object minimum, object maximum,
            string parameterName) =>
            new ArgumentOutOfRangeException(parameterName,
                $"{parameterName} with the value {value} is out of range [{minimum};{maximum}]");

        private static ArgumentOutOfRangeException GreaterOrEqualException(object value, object minimum,
            string parameterName) =>
            new ArgumentOutOfRangeException(parameterName,
                $"{parameterName} with value {value} must be greater of equals to {minimum}");

        private static ArgumentOutOfRangeException LessOrEqualException(object value, object maximum,
            string parameterName) =>
            new ArgumentOutOfRangeException(parameterName,
                $"{parameterName} with value {value} must be less of equals to {maximum}");
        ...
        private static ArgumentException RegexException(string parameterName) =>
            new ArgumentException($"{parameterName} must be a formatted regex");
        ...
        public static void NotNull<ReferenceType>(ReferenceType value, string parameterName)
        ...
        [ContractArgumentValidator]
        public static void GreaterThanOrEqualTo<ObjectType>(ObjectType value, ObjectType minimum,
            string parameterName) where ObjectType : class, IComparable<ObjectType>
        {
        ...
        [ContractArgumentValidator]
        public static void LessThanOrEqualTo<ObjectType>(ObjectType value, ObjectType maximum, string parameterName)
            where ObjectType : class, IComparable<ObjectType>
        {
        ...
        [ContractArgumentValidator]
        public static void IsRegex(string regex, string parameterName)
        {
            try
            {
                Regex.Match("", regex);
            ...
            {
                throw RegexException(parameterName);
            }
